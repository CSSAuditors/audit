...
const report = (sites, name) => {
  ...
  if(!helpers.fileExists(extractorFile) && sites.list) {
    ...
    extractorData.avgSizeImport = {
      size: calc.getAverage(extractorData.list, 'link-or-import', 'size'),
    ...
    extractorData.avgSizeStyle = {
      size: calc.getAverage(extractorData.list, 'style', 'size'),
    ...
    extractorData.avgSizeInline = {
      size: calc.getAverage(extractorData.list, 'inline', 'size'),
